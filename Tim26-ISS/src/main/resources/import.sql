...
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Marko', 'Markovic', '0662322322', 'marko2@gmail.com', 'Ulica br 1', 'marko123', 0, 0, 'PASSENGER','PASSENGER');
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Dejan', 'Dejanovic', '0662869522', 'dejan@gmail.com', 'Ulica br 2', 'dejan123', 0, 0,  'DRIVER','DRIVER');
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Nikola', 'Nikolic', '0662300998', 'nikola@gmail.com', 'Ulica br 3', 'nikola123', 0, 0,  'PASSENGER','PASSENGER');
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Milica', 'Milic', '0662322444', 'milica@gmail.com', 'Ulica br 4', 'milica123', 0, 0,  'DRIVER','DRIVER');
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Milos', 'Milosevic', '0661111112', 'milos@gmail.com', 'Ulica br 5', 'milos123', 0, 0,  'PASSENGER','PASSENGER');
insert into users_table (name, surname, telephone_number, email, address, password, blocked_flag, active_flag, role, type) values ('Andrej', 'Mitrovic', '0664242322', 'mitrovicandrej5@gmail.com', 'Ulica br 5', 'andrej123', 0, 0, 'PASSENGER','PASSENGER');
